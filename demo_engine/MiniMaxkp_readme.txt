...
The above mentioned source and binary files should be in an "engine_demo_files" subdirectory at my github repository site for my chess pgn viewer/db utility which is:
