                ...
                Else
                  If FileSize(EngineOrListFile) > 0
                    ...
                    For i = 2 To #numAllowedEngines
                      Repeat
                        Engine_Path(i) = InputRequester("Match Engine Path (path must exist)", "Please enter the complete file path of your Engine" + Chr(65+i) + " executable (If any): ", "/Applications/ChessEnginesOSX/someEngine")
                  ...
                  Else
                    For i = 1 To #numAllowedEngines
                      Repeat
                        Engine_Path(i) = InputRequester("Match Engine Path (path must exist)", "Please enter the complete file path of your Engine" + Chr(64+i) + " executable (If any): ", "/Applications/ChessEnginesOSX/someEngine")
                      Until FileSize(Engine_Path(i)) > 0 Or Engine_Path(i) = ""
                      If Engine_Path(i) = ""
                        Break
                      Else
...
; EnableXP
; DPIAware
; Executable = PGNdbkp_20260109.app
