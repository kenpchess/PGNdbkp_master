...
If CreateImage(#ImageID_DemoBkgnd, #ImageWidth, #ImageHeight,32,#White)
  ...
  If StartVectorDrawing(ImageVectorOutput(#ImageID_DemoBkgnd))
    ...
    MovePathCursor(#doc_offset, #demo_y_offset + PDFSquareSize*6)
...
EndIf
  ...
  ;DrawVectorImage(ImageID(#ImageID_DemoBkgnd), 255, PDFSquareSize*8, PDFSquareSize*8)
...
For k = Val(GameLink0) To Games_Export_Count
  ...
  DrawVectorTextDemoDataToImage(k)
...
; EnableXP
; DPIAware
; Executable = PGNdbkp_20250904.app