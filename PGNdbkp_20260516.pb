...
Global MiniMaxkp_move.s, Go_command.s
          ...
          Case #PB_EventType_LeftClick
            Select EventGadget()
              ...
              Case #Btn_PlayMinimax
                OpenConsole()
                MiniMaxkp_path = InputRequester("Path of Your MiniMaxkp engine binary.", "Enter the full path of your MiniMaxkp engine binary [original binary in github utilities folder]: ", "/users/kenpchess/Desktop/MiniMaxkp_20260515")
                ; nothing else yet
                CreateThread(@MiniMaxkp_Start_Thread(),1)
                Delay(500)
                ;wflags = #PB_Window_SizeGadget | #PB_Window_SystemMenu | #PB_Window_ScreenCentered
...
; EnableXP
; DPIAware
; Executable = PGNdbkp_20260516.app
; Debugger = Console
